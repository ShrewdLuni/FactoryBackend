...
const relations = {
  device: z.object({
    id: DeviceSchema.shape.id.nullish(),
...
export const BatchTransitionRowSchema = z.object({
  ...
  from_status_label: relations.fromStatus.shape.label.nullish(),
  from_status_sort_order: relations.fromStatus.shape.sortOrder.nullish(),
  from_status_is_terminal: relations.fromStatus.shape.isTerminal.nullish(),
  from_status_allows_defect_reporting: relations.fromStatus.shape.allowsDefectReporting.nullish(),
  from_status_is_active: relations.fromStatus.shape.isActive.nullish(),
  from_status_is_in_progress: relations.fromStatus.shape.isInProgress.nullish(),
  from_status_is_finished: relations.fromStatus.shape.isFinished.nullish(),
  from_status_requires_size_input: relations.fromStatus.shape.requiresSizeInput.nullish(),
  from_status_is_packaging: relations.fromStatus.shape.isPackaging.nullish(),
  from_status_subtract_defects: relations.fromStatus.shape.subtractDefects.nullish(),
  from_status_is_milestone: relations.fromStatus.shape.isMilestone.nullish(),
  ...
  to_status_label: relations.toStatus.shape.label.nullish(),
  to_status_sort_order: relations.toStatus.shape.sortOrder.nullish(),
  to_status_is_terminal: relations.toStatus.shape.isTerminal.nullish(),
  to_status_allows_defect_reporting: relations.toStatus.shape.allowsDefectReporting.nullish(),
  to_status_is_active: relations.toStatus.shape.isActive.nullish(),
  to_status_is_in_progress: relations.toStatus.shape.isInProgress.nullish(),
  to_status_is_finished: relations.toStatus.shape.isFinished.nullish(),
  to_status_requires_size_input: relations.toStatus.shape.requiresSizeInput.nullish(),
  to_status_is_packaging: relations.toStatus.shape.isPackaging.nullish(),
  to_status_subtract_defects: relations.toStatus.shape.subtractDefects.nullish(),
  to_status_is_milestone: relations.toStatus.shape.isMilestone.nullish(),
